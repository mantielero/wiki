...
$$\begin{array}{c}
 Y &\approx n^0 (\alpha = 0) &\text{, intensiva} \\
...
> Nota: Cuando el manómetro en U está sin conectar, el mercurio alcanza 50 cm en cada rama.
